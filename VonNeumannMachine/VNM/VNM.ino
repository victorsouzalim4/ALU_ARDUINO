...
class VonNeumannMachine{
  ...
  char fromBinaryToHexa(String value){
   if(value.compareTo("0000") == 0){ return '0';
   }else if(value.compareTo("0001") == 0){ return '1';
   }else if(value.compareTo("0010") == 0){ return '2';
   }else if(value.compareTo("0011") == 0){ return '3';
   }else if(value.compareTo("0100") == 0){ return '4';
   }else if(value.compareTo("0101") == 0){ return '5';
   }else if(value.compareTo("0110") == 0){ return '6';
   }else if(value.compareTo("0111") == 0){ return '7';
   }else if(value.compareTo("1000") == 0){ return '8';
   }else if(value.compareTo("1001") == 0){ return '9';
   }else if(value.compareTo("1010") == 0){ return 'A';
   }else if(value.compareTo("1011") == 0){ return 'B';
   }else if(value.compareTo("1100") == 0){ return 'C';
   }else if(value.compareTo("1101") == 0){ return 'D';
   }else if(value.compareTo("1110") == 0){ return 'E';
   }else if(value.compareTo("1111") == 0){ return 'F';
   }else{ return '0';}
  }
  ...
  char op0(char a, char b) { return orGate(a, notGate(a)); }
  char op1(char a, char b) { return orGate(a, notGate(b)); }
  char op2(char a, char b) { return andGate(a, a); }
  char op3(char a, char b) { return xorGate(notGate(a), notGate(b)); }
  char op4(char a, char b) { return notGate(andGate(a, b)); }
  char op5(char a, char b) { return notGate(a); }
  char op6(char a, char b) { return andGate(a, notGate(b)); }
  char op7(char a, char b) { return orGate(notGate(a), notGate(b)); }
  char op8(char a, char b) { return xorGate(a, b); }
  char op9(char a, char b) { return andGate(a, notGate(a)); }
  char opA(char a, char b) { return andGate(b, b); }
  char opB(char a, char b) { return andGate(a, b); }
  char opC(char a, char b) { return notGate(b); }
  char opD(char a, char b) { return notGate(andGate(notGate(a), b)); }
  char opE(char a, char b) { return orGate(a, b); }
  char opF(char a, char b) { return andGate(notGate(a), b); }
}
